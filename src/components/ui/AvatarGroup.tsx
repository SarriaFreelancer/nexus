    ...
    <div className="flex items-center -space-x-2 overflow-hidden">
      {visibleUsers.map((user, idx) => (
        <img
          ...
          className="inline-block h-6 w-6 rounded-full shrink-0 object-cover"
      ...
      {extraCount > 0 && (
        <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-indigo-900/80 text-[10px] font-semibold text-indigo-200">
          +{extraCount}
        </div>
      )}
    </div>
