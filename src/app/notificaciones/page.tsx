  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-[#0f1424] border border-slate-200 dark:border-slate-800/80 space-y-3 shadow-xl">
        {notifs.map((n, idx) => (
          <div key={idx} className={`p-4 rounded-xl border transition-all flex items-start justify-between ${n.unread ? "bg-slate-100 dark:bg-slate-900 border-indigo-500/40" : "bg-slate-100 dark:bg-slate-900/40 border-slate-200 dark:border-slate-800"}`}>
