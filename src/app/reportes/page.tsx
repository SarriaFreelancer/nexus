    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 rounded-2xl bg-[#0f1424] border border-slate-800/80 space-y-3 shadow-xl">
          <h3 className="font-bold text-slate-100 text-sm">Rendimiento por Desarrollador</h3>
          <p className="text-xs text-slate-400">Horas completadas vs estimadas en el sprint actual.</p>
        ...
        <div className="p-5 rounded-2xl bg-[#0f1424] border border-slate-800/80 space-y-3 shadow-xl">
          <h3 className="font-bold text-slate-100 text-sm">Rentabilidad por Proyecto</h3>
          <p className="text-xs text-slate-400">Valor cobrado vs costo de horas invertidas.</p>
          <div className="space-y-2 pt-2">
